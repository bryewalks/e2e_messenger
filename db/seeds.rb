...
Conversation.create([{author_id: '1', receiver_id: '2'},{author_id: '1', receiver_id: '3'},{author_id: '1', receiver_id: '4'},{author_id: '2', receiver_id: '3'},{author_id: '2', receiver_id: '4'},{author_id: '3', receiver_id: '4'}])
...
user_array.each do |user|
  ...
  3.times do
    ...
    5.times do 
      Message.create!(user_id: user, conversation_id: conversation.id, body: Faker::Hacker.say_something_smart)
      Message.create!(user_id: receiver, conversation_id: conversation.id, body: Faker::Hacker.say_something_smart)
    end
  end
end
